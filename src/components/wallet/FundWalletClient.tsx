...
export default function FundWalletClient() {
  ...
  const onSubmit = async (data: FundWalletFormValues) => {
    ...
    try {
      ...
      toast({
        title: 'Wallet funding isn\'t available yet',
        description: 'We\'re still setting up secure payment processing for wallet top-ups. Please check back soon, or pay by card/delivery at checkout instead.',
        variant: 'destructive',
        duration: 8000,
      });
    } finally {
