...
export default function SelectRolePage() {
  ...
  return (
    <Card className="w-full max-w-md text-center border-white/10 bg-white/[0.04] backdrop-blur-2xl shadow-[0_0_60px_-15px] shadow-primary/30">
      <CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <Button
          size="lg"
          variant="outline"
          className="w-full border-white/15 bg-white/[0.03] text-white hover:bg-white/10 hover:text-white"
